...
import net.taki.minecrown.block.BlockRedIron;
...
public class ProcedureFusionProcedure extends ElementsMinecrownMOD.ModElement {
	public ProcedureFusionProcedure(ElementsMinecrownMOD instance) {
		super(instance, 5);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure FusionProcedure!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure FusionProcedure!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure FusionProcedure!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure FusionProcedure!");
			return;
		}
		...
		if (((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				&& ((new Object() {
					public ItemStack getItemStack(BlockPos pos, int sltid) {
						...
						}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getMetadata() == new ItemStack(Items.REDSTONE, (int) (1))
								.getMetadata()))
				&& (((new Object() {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == new ItemStack(BlockRedIron.block, (int) (1))
						.getItem() && (new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								TileEntity inv = world.getTileEntity(pos);
								if (inv instanceof TileEntityLockableLoot)
								...
								.getMetadata() == new ItemStack(BlockRedIron.block, (int) (1)).getMetadata())))) {
			{
			...
			}
			{
				...
				if (inv != null && (inv instanceof TileEntityLockableLoot)) {
					ItemStack _setstack = new ItemStack(BlockRedIron.block, (int) (1));
