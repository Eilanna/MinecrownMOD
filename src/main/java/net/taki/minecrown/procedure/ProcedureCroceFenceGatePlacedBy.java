...
public class ProcedureCroceFenceGatePlacedBy extends ElementsMinecrownMOD.ModElement {
	public ProcedureCroceFenceGatePlacedBy(ElementsMinecrownMOD instance) {
		super(instance, 199);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure CroceFenceGatePlacedBy!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure CroceFenceGatePlacedBy!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure CroceFenceGatePlacedBy!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure CroceFenceGatePlacedBy!");
			return;
		}
