...
import net.taki.minecrown.block.BlockLogFenceGateOpen;
...
public class ProcedureLogFenceGateRightClicked extends ElementsMinecrownMOD.ModElement {
	public ProcedureLogFenceGateRightClicked(ElementsMinecrownMOD instance) {
		super(instance, 130);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure LogFenceGateRightClicked!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure LogFenceGateRightClicked!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure LogFenceGateRightClicked!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure LogFenceGateRightClicked!");
			return;
		}
		...
		if ((((new Object() {
			...
			if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == BlockLogFenceGateClosed.block.getDefaultState()
					.getBlock()) && ((new Object() {
						public EnumFacing getEnumFacing(BlockPos pos) {
							try {
								IBlockState _bs = world.getBlockState(pos);
				...
				world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockLogFenceGateOpen.block.getDefaultState(), 3);
				try {
			...
			} else if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == BlockLogFenceGateOpen.block.getDefaultState()
					.getBlock()) && ((new Object() {
						public EnumFacing getEnumFacing(BlockPos pos) {
							try {
								IBlockState _bs = world.getBlockState(pos);
				...
				world.setBlockToAir(new BlockPos((int) x, (int) y, (int) z));
				world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockLogFenceGateClosed.block.getDefaultState(), 3);
				try {
					IBlockState _bs = world.getBlockState(new BlockPos((int) x, (int) y, (int) z));
					for (IProperty<?> prop : _bs.getProperties().keySet()) {
						if (prop.getName().equals("facing")) {
			...
			} else if ((((world.getBlockState(new BlockPos((int) x, (int) y, (int) z))).getBlock() == BlockLogFenceGateClosed.block.getDefaultState()
					.getBlock()) && ((new Object() {
						public EnumFacing getEnumFacing(BlockPos pos) {
							try {
								IBlockState _bs = world.getBlockState(pos);
