...
public class ProcedureProcessMachineAMoudreCraft extends ElementsMinecrownMOD.ModElement {
	public ProcedureProcessMachineAMoudreCraft(ElementsMinecrownMOD instance) {
		super(instance, 4);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure ProcessMachineAMoudreCraft!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure ProcessMachineAMoudreCraft!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure ProcessMachineAMoudreCraft!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure ProcessMachineAMoudreCraft!");
			return;
		}
