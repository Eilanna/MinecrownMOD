	...
	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		...
		if ((((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(ItemRaspberry.block, (int) (1))
						.getItem() && (new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								TileEntity inv = world.getTileEntity(pos);
								if (inv instanceof TileEntityLockableLoot)
								...
								.getMetadata() == new ItemStack(ItemRaspberry.block, (int) (1)).getMetadata()))
				&& (((new Object() {
					public int getAmount(BlockPos pos, int sltid) {
						TileEntity inv = world.getTileEntity(pos);
						if (inv instanceof TileEntityLockableLoot) {
		...
		if ((((((new Object() {
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (1))).getItem() == new ItemStack(ItemCandleBerry.block, (int) (1))
						.getItem() && (new Object() {
							public ItemStack getItemStack(BlockPos pos, int sltid) {
								TileEntity inv = world.getTileEntity(pos);
								if (inv instanceof TileEntityLockableLoot)
								...
								.getMetadata() == new ItemStack(ItemCandleBerry.block, (int) (1)).getMetadata()))
				&& (((new Object() {
					public int getAmount(BlockPos pos, int sltid) {
						TileEntity inv = world.getTileEntity(pos);
						if (inv instanceof TileEntityLockableLoot) {
