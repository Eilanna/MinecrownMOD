...
public class ProcedureRopeFenceGatePlacedBy extends ElementsMinecrownMOD.ModElement {
	public ProcedureRopeFenceGatePlacedBy(ElementsMinecrownMOD instance) {
		super(instance, 149);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure RopeFenceGatePlacedBy!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure RopeFenceGatePlacedBy!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure RopeFenceGatePlacedBy!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure RopeFenceGatePlacedBy!");
			return;
		}
