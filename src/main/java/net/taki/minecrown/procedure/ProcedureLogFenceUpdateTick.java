...
public class ProcedureLogFenceUpdateTick extends ElementsMinecrownMOD.ModElement {
	public ProcedureLogFenceUpdateTick(ElementsMinecrownMOD instance) {
		super(instance, 127);
	}

	public static void executeProcedure(java.util.HashMap<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure LogFenceUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure LogFenceUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure LogFenceUpdateTick!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure LogFenceUpdateTick!");
			return;
		}
