...
public class BlockCranberryBush_1 extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:cranberrybush_1")
	public static final Block block = null;
	public BlockCranberryBush_1(ElementsMinecrownMOD instance) {
		super(instance, 11);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minecrown:cranberrybush_1", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("cranberrybush_1");
			setRegistryName("cranberrybush_1");
		}
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(ItemCranberrySeed.block, (int) (1));
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureCranberryBush_Transform1.executeProcedure($_dependencies);
			}
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureCranberryBush_Break1.executeProcedure($_dependencies);
			}
			return retval;
		}
