...
public class BlockCranberryBush_3 extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:cranberrybush_3")
	public static final Block block = null;
	public BlockCranberryBush_3(ElementsMinecrownMOD instance) {
		super(instance, 13);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minecrown:cranberrybush_3", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("cranberrybush_3");
			setRegistryName("cranberrybush_3");
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureCranberryBush_Break3.executeProcedure($_dependencies);
			}
			return retval;
		}
