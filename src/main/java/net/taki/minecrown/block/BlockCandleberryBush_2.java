...
import net.taki.minecrown.procedure.ProcedureCandleberryBush_Transform2;
import net.taki.minecrown.procedure.ProcedureCandleberryBush_Recolt2;
import net.taki.minecrown.procedure.ProcedureCandleberryBush_Break2;
...
public class BlockCandleberryBush_2 extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:candleberrybush_2")
	public static final Block block = null;
	public BlockCandleberryBush_2(ElementsMinecrownMOD instance) {
		super(instance, 95);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minecrown:candleberrybush_2", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("candleberrybush_2");
			setRegistryName("candleberrybush_2");
		}
		...
		public ItemStack getPickBlock(IBlockState state, RayTraceResult target, World world, BlockPos pos, EntityPlayer player) {
			return new ItemStack(ItemCandleberrySeed.block, (int) (1));
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureCandleberryBush_Transform2.executeProcedure($_dependencies);
			}
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureCandleberryBush_Break2.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureCandleberryBush_Recolt2.executeProcedure($_dependencies);
			}
			return true;
		}
	}
