...
import net.taki.minecrown.procedure.ProcedureBlackberryBush_Transform1;
import net.taki.minecrown.procedure.ProcedureBlackberryBush_Break1;
...
public class BlockBlackberryBush_1 extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:blackberrybush_1")
	public static final Block block = null;
	public BlockBlackberryBush_1(ElementsMinecrownMOD instance) {
		super(instance, 44);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minecrown:blackberrybush_1", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("blackberrybush_1");
			setRegistryName("blackberrybush_1");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureBlackberryBush_Transform1.executeProcedure($_dependencies);
			}
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureBlackberryBush_Break1.executeProcedure($_dependencies);
			}
			return retval;
		}
