...
public class BlockRopeFenceStraight extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:ropefencestraight")
	public static final Block block = null;
	public BlockRopeFenceStraight(ElementsMinecrownMOD instance) {
		super(instance, 139);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ropefencestraight"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "minecrown:tileentityropefencestraight");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minecrown:ropefencestraight", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("ropefencestraight");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return "container.ropefencestraight";
		}
		...
		public String getGuiID() {
			return "minecrown:ropefencestraight";
		}
