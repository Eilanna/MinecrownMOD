...
import net.taki.minecrown.procedure.ProcedureCandleberryBush_Recolt3;
import net.taki.minecrown.procedure.ProcedureCandleberryBush_Break3;
...
public class BlockCandleberryBush_3 extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:candleberrybush_3")
	public static final Block block = null;
	public BlockCandleberryBush_3(ElementsMinecrownMOD instance) {
		super(instance, 96);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minecrown:candleberrybush_3", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("candleberrybush_3");
			setRegistryName("candleberrybush_3");
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureCandleberryBush_Break3.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureCandleberryBush_Recolt3.executeProcedure($_dependencies);
			}
			return true;
		}
	}
