...
public class BlockJsonBush extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:jsonbush")
	public static final Block block = null;
	public BlockJsonBush(ElementsMinecrownMOD instance) {
		super(instance, 122);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("minecrown:jsonbush", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("jsonbush");
			setRegistryName("jsonbush");
		}
