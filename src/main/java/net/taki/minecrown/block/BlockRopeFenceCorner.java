...
public class BlockRopeFenceCorner extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:ropefencecorner")
	public static final Block block = null;
	public BlockRopeFenceCorner(ElementsMinecrownMOD instance) {
		super(instance, 137);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("ropefencecorner"));
		elements.items.add(() -> new ItemBlock(block).setRegistryName(block.getRegistryName()));
	}

	@Override
	public void init(FMLInitializationEvent event) {
		GameRegistry.registerTileEntity(TileEntityCustom.class, "minecrown:tileentityropefencecorner");
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minecrown:ropefencecorner", "inventory"));
	}
	public static class BlockCustom extends Block implements ITileEntityProvider {
		public static final PropertyDirection FACING = BlockHorizontal.FACING;
		public BlockCustom() {
			super(Material.WOOD);
			setUnlocalizedName("ropefencecorner");
	...
	public static class TileEntityCustom extends TileEntityLockableLoot {
		...
		public String getName() {
			return "container.ropefencecorner";
		}
		...
		public String getGuiID() {
			return "minecrown:ropefencecorner";
		}
