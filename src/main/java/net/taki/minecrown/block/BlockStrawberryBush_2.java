...
import net.taki.minecrown.procedure.ProcedureStrawberryBush_Transform2;
import net.taki.minecrown.procedure.ProcedureStrawberryBush_Recolt2;
import net.taki.minecrown.procedure.ProcedureStrawberryBush_Break2;
...
public class BlockStrawberryBush_2 extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:strawberrybush_2")
	public static final Block block = null;
	public BlockStrawberryBush_2(ElementsMinecrownMOD instance) {
		super(instance, 63);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minecrown:strawberrybush_2", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("strawberrybush_2");
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureStrawberryBush_Transform2.executeProcedure($_dependencies);
			}
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureStrawberryBush_Break2.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureStrawberryBush_Recolt2.executeProcedure($_dependencies);
			}
			return true;
		}
	}
