...
import net.taki.minecrown.procedure.ProcedureStrawberryBush_Transform0;
import net.taki.minecrown.procedure.ProcedureStrawberryBush_Break0;
...
public class BlockStrawberryBush_0 extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:strawberrybush_0")
	public static final Block block = null;
	public BlockStrawberryBush_0(ElementsMinecrownMOD instance) {
		super(instance, 61);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minecrown:strawberrybush_0", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setResistance(0F);
			setLightLevel(0F);
			setUnlocalizedName("strawberrybush_0");
			setRegistryName("strawberrybush_0");
		}
		...
		public void updateTick(World world, BlockPos pos, IBlockState state, Random random) {
			...
			int z = pos.getZ();
			{
				...
				ProcedureStrawberryBush_Transform0.executeProcedure($_dependencies);
			}
		}
		...
		public boolean removedByPlayer(IBlockState state, World world, BlockPos pos, EntityPlayer entity, boolean willHarvest) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureStrawberryBush_Break0.executeProcedure($_dependencies);
			}
			return retval;
		}
