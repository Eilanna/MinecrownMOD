...
import net.taki.minecrown.procedure.ProcedureStrawberryBush_Recolt3;
import net.taki.minecrown.procedure.ProcedureStrawberryBush_Break3;
...
public class BlockStrawberryBush_3 extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:strawberrybush_3")
	public static final Block block = null;
	public BlockStrawberryBush_3(ElementsMinecrownMOD instance) {
		super(instance, 64);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("minecrown:strawberrybush_3", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockFlower {
		public BlockCustomFlower() {
			...
			setRegistryName("strawberrybush_3");
		}
		...
		public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction,
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				ProcedureStrawberryBush_Recolt3.executeProcedure($_dependencies);
			}
			return true;
		}
	}
