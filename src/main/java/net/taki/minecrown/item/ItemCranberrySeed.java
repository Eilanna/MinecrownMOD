...
public class ItemCranberrySeed extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:cranberryseed")
	public static final Item block = null;
	public ItemCranberrySeed(ElementsMinecrownMOD instance) {
		super(instance, 20);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minecrown:cranberryseed", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing direction, float hitX, float hitY,
			...
			int z = pos.getZ();
			{
				...
				ProcedureCranberryBushPlantation.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
