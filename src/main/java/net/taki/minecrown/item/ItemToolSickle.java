...
public class ItemToolSickle extends ElementsMinecrownMOD.ModElement {
	@GameRegistry.ObjectHolder("minecrown:toolsickle")
	public static final Item block = null;
	public ItemToolSickle(ElementsMinecrownMOD instance) {
		super(instance, 183);
	}
	...
	public void initElements() {
		...
		}.setUnlocalizedName("toolsickle").setRegistryName("toolsickle").setCreativeTab(TabMiCroJobsBotaniste.tab));
	}

	@SideOnly(Side.CLIENT)
	@Override
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("minecrown:toolsickle", "inventory"));
	}
