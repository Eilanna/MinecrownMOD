...
public class GuiCvcxv extends ElementsMinecrownMOD.ModElement {
	public static int GUIID = 6;
	public static HashMap guistate = new HashMap();
	public GuiCvcxv(ElementsMinecrownMOD instance) {
		super(instance, 13);
	}
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("minecrown:textures/cvcxv.png");
		@Override
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 50, this.guiTop + 66, 50, 20, "fdsfs"));
		}
