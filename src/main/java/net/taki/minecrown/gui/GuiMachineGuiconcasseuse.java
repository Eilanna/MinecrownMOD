...
public class GuiMachineGuiconcasseuse extends ElementsMinecrownMOD.ModElement {
	public static int GUIID = 14;
	public static HashMap guistate = new HashMap();
	public GuiMachineGuiconcasseuse(ElementsMinecrownMOD instance) {
		super(instance, 216);
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 17, 57) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 116, 21) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(3, this.addSlotToContainer(new Slot(internal, 3, 134, 21) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(4, this.addSlotToContainer(new Slot(internal, 4, 107, 39) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
			}));
			this.customSlots.put(5, this.addSlotToContainer(new Slot(internal, 5, 143, 39) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return false;
				}
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				MinecrownMOD.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("minecrown:textures/machineguiconcasseuse.png");
		@Override
		...
		protected void actionPerformed(GuiButton button) {
			MinecrownMOD.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
