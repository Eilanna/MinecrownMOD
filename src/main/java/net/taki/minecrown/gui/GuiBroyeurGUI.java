...
public class GuiBroyeurGUI extends ElementsMinecrownMOD.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 35, 21) {
			}));
			this.customSlots.put(1, this.addSlotToContainer(new Slot(internal, 1, 35, 57) {
			}));
			this.customSlots.put(2, this.addSlotToContainer(new Slot(internal, 2, 80, 39) {
				@Override
	...
	public static class GuiWindow extends GuiContainer {
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Machine \u00E0 Moudre", 79, 20, -1);
		}
		...
		public void initGui() {
			...
			this.buttonList.add(new GuiButton(0, this.guiLeft + 106, this.guiTop + 56, 60, 20, "Broyer"));
		}
